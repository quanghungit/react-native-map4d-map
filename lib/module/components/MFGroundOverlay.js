...
import { requireNativeComponent, View, ViewPropTypes } from 'react-native'; // if ViewPropTypes is not defined fall back to View.propType (to support RN < 0.44)
...
class MFGroundOverlay extends React.Component {
  render() {
    return /*#__PURE__*/React.createElement(RMFGroundOverlay, this.props);
  }
